...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: "Use Cases - JoeWork.co", // Placeholder
    description: "Explore how JoeWork.co automates tasks for LATAM SMEs.", // Placeholder
...
export default async function UseCasesPage({ params: { locale } }: Props) {
  // TODO: Add translations for this page content
  // const t = await getTranslations({ locale, namespace: 'Page.UseCases' });
